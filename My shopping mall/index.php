...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
<tr>
<td class="hanamii" height="30" bgcolor="#C4E0E5" align="center"> <b>New Arrivals</b>
</td>
</tr>
<tr>
...
<tr>
<td align="center" valign="top" width="115" height="120">
<a href="shopping/details.php?num=<?=$rows2[num]?>&l_code=<?=category_fk ?>"><img src="upload/p_image/m/<?=$rows2[prod_code]?>.<?=$rows2[m_image_ty] ?>" width="120" height="120" border="0" onerror="this.src='img/noimage.gif'">
</td>
</tr>
<tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
			<tr>
				<td class="hanamii" colspan="3" height="30" bgcolor="#C4E0E5" align="center"> <b>New Auction</b>
				</td>
			</tr>
<?		
		for($j=1; $j<=5; $j++) { ?>
